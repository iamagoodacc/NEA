...
<body>
    <div class="reportsPage">
        ...
        <div class="page">
            <div class="topBar">
                <div class="message">
                    Unveil your achievements! Dive into your learning progress!
                </div>
                    ...
                    <div class="headings">
                        <div class="titles">
                            <div class="leftTitles">
                                ...
                                <div class="setTitle">Set by</div>
                                <div class="nameTitle">Name</div>
                            </div>
                            <div class="rightTitles">
                                <div class="markTitle">Mark</div>
                                <div class="maxMarkTitle">Max Mark</div>
                                <div class="gradeTitle">Grade</div>
                            </div>
                        </div>
                    ...
                    <div class="reports">
                        <template id="reportTemplate">
                            <div class="leftDetails">
                                <div class="dateDetails">1 July 2024</div>
                                <div class="subjectDetails">
                                    <div class="subjectName">Maths</div>
                                    <div class="subjectClass">Ma.1</div>
                                </div>
                                <div class="setDetails">Mr Johnson</div>
                                <div class="taskDetails">
                                    <div class="taskLink">Complete Worksheet</div>
                                </div>
                            </div>
                            <div class="rightDetails">
                                <div class="markDetails">75</div>
                                <div class="maxMarkDetails">80</div>
                                <div class="gradeDetails">9</div>
                            </div>
                        </template>
                    </div>
                </div>
