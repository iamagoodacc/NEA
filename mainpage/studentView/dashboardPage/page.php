            ...
            <div class="pageView">
                <div class="statistics">
                    <div class="attendanceStats">
                        <div class="attendanceTitles">
                            <div class="attendanceValue">80%</div>
                            <div class="attendanceTitle">Attendance</div>
                        </div>
                        <canvas class="attendanceChart">
                        </canvas>
                        <div class="attendanceDetails">
                            <div class="presents">
                                <div class="presentsTitle">Presents</div>
                                <div class="presentsValue">964</div>
                            </div>
                            <div class="background"></div>
                            <div class="absents">
                                <div class="absentsTitle">Absents</div>
                                <div class="absentsValue">236</div>
                            </div>
                            <div class="background"></div>
                            <div class="available">
                                <div class="availableTitle">Available</div>
                                <div class="availableValue">1200</div>
                            </div>
                        </div>
                    </div>
                    <div class="timetable">
                ...
                <div class="recents">
                    <div class="dueAssignments">
                        <div class="titles">
                            <div class="title">Due Assignments</div>
                            <div class="horizontalBar"></div>
                            <div class="headings">
                                <div class="dueDateTitle">Due</div>
                                <div class="assignmentSubjectTitle">Subject</div>
                                <div class="assignmentTitle">Title</div>
                            </div>
                        </div>
                        <div class="assignments">
                            <template id="assignmentTemplate" class="assignment">
                                <div class="dueDate">1 July 2024</div>
                                <div class="subject">Geography</div>
                                <div class="title">Create a mini volcano</div>
                            </template>
                        </div>
                    </div>
                        ...
                        <div class="notices">
                            <template id="noticeTemplate">
                                ...
                                <div class="noticeText">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer pellentesque posuere justo a pulvinar. Interdum et malesuada fames ac ante ipsum primis in faucibus. Proin sit amet neque blandit, blandit sapien in, accumsan orci. Nam fringilla, magna non vulputate maximus, orci risus interdum tellus, sed pellentesque sem dui quis est. Integer pellentesque ipsum nunc, sit amet tincidunt quam aliquet sed. Pellentesque tincidunt ac libero et suscipit. Integer imperdiet non sem et dictum. Suspendisse bibendum justo vitae elit convallis, sed ultricies turpis pretium. In eu faucibus velit, vitae viverra urna. Sed vehicula iaculis magna, efficitur vulputate ligula mattis sagittis. Sed faucibus interdum massa, sed pretium magna. Etiam ac urna sed mi commodo finibus. Praesent vitae aliquet libero. Ut at dignissim quam. Nullam felis augue, rhoncus sed gravida eu, fermentum ut ipsum.
                                </div>
                            </template>
                        </div>
                    </div>
