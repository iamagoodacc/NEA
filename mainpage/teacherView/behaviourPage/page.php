...
<body>
    <div class="behaviourPage">
        ...
        <div class="page">
            <div class="topBar">
                <div class="message">
                    Worried for your students? Let's track their behaviour!
                </div>
                ...
                <div class="left">
                    <div class="studentSelector">
                        <div class="generalDetails">
                            <div class="yearGroup">
                                <div class="title">Year group: </div>
                                <input type="text" name="yearGroup" class="yearGroupInput">
                            </div>
                            <div class="class">
                                <div class="title">Class: </div>
                                <input type="text" name="class" class="classInput">
                            </div>
                        </div>
                        <div class="studentBackground">
                            <div class="container">
                    ...
                    <div class="recentBehaviourEvents">
                        ...
                        <div id="events" class="recentEvents">
