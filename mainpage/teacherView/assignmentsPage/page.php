...
<body>
    <div class="assignmentsPage">
        ...
        <div class="page">
            <div class="topBar">
                <div class="message">
                    Harness your students' potentials: What will you assign today?
                            ...
                            <div class="descriptionCenter">
                                <div class="circleIcon">
                                    <svg viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M18.9 13.5C18.9 14.2452 18.2952 14.85 17.55 14.85H14.85V17.55C14.85 18.2952 14.2452 18.9 13.5 18.9C12.7548 18.9 12.15 18.2952 12.15 17.55V14.85H9.45001C8.70481 14.85 8.1 14.2452 8.1 13.5C8.1 12.7548 8.70481 12.15 9.45001 12.15H12.15V9.45C12.15 8.7048 12.7548 8.1 13.5 8.1C14.2452 8.1 14.85 8.7048 14.85 9.45V12.15H17.55C18.2952 12.15 18.9 12.7548 18.9 13.5ZM13.5 24.3C7.54515 24.3 2.7 19.4548 2.7 13.5C2.7 7.54515 7.54515 2.7 13.5 2.7C19.4548 2.7 24.3 7.54515 24.3 13.5C24.3 19.4548 19.4548 24.3 13.5 24.3ZM13.5 0C6.04395 0 0 6.04395 0 13.5C0 20.9561 6.04395 27 13.5 27C20.956 27 27 20.9561 27 13.5C27 6.04395 20.956 0 13.5 0Z" />
                                    </svg>
                                </div>
