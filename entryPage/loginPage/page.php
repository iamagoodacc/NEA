            ...
            <div class="loginContainer">
                ...
                <div class="contents">
                    ...
                    <div class="details">
                        ...
                        <div class="extras">
                            <div id="forgottenPasswordButton" class="forgottenPassword">Forgotten Password?</div>
                            <div id="createAccountButton" class="createAccount">Don't have an account? Create one!</div>
                        </div>
                    </div>
                </div>
                <div class="signInContainer">
                    <button id="signInButton" class="signInText">SIGN IN</button>
                </div>
